...
export default function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden bg-zinc-900 text-white">
      ...
      <div className="relative z-10 flex flex-col h-full px-6 pb-12 pt-32 sm:px-12 md:px-24 max-w-[1600px] mx-auto">
        <div className="flex-1 flex flex-col justify-center translate-y-[-5%]">
          <motion.h1 
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
            className="text-5xl md:text-7xl lg:text-[110px] leading-[0.95] font-medium tracking-tight"
          >
